...
<body>
  ...
  <div class="wrapper ">
    ...
    <ul class="list-menu">
      <li class="list"><a href="ProductFactsheet.php">Product Sheet</a></li>
      <li class="list"><a href="Brochure.php">Brochure</a></li>
      <li class="list"><a href="Service.php">Service</a></li>
      <li class="list"><a href="Video.php">Video</a></li>
      <li class="list"><a href="ProductContent.php">Content</a></li>
      <li class="list"><a href="Document.php">Documents</a></li>
    </ul>
  ...
  <div id="crudApp">
      ...
      <div class="row">
        ...
        <div class="col-md-4 col-6 mt-3 " v-for="row in allDataBidet" data-aos="fade-up" data-aos-duration="1000">
          <div class="panel panel-default" data-aos="fade-up" data-aos-duration="1500">
            ...
            <div class="box-white-product" data-aos="zoom-in">
        <h4>Massage Chair | เครื่องนวดไฟฟ้า</h4>
      </div>
      <br>
      <div class="row">
        <div class="col-md-4 col-6 mt-3 " v-for="row in allDataMassage" data-aos="fade-up" data-aos-duration="1000">
          <div class="panel panel-default" data-aos="fade-up" data-aos-duration="1500">
            <div class="panel-body">
              <a href="#" data-toggle="modal" data-target="#lightbox">
                <img class="img-product" v-bind:src="row.img_src" alt="..." onclick="onClick(this)">
          ...
          <div class="row pt-5">
              ...
              <div class="col-md-7 text-center">
                  ...
                  <h3 class="text-catalog-subheader" data-aos="zoom-in">วัฒนธรรมใหม่ของการดื่มน้ำ</h3>
                    ...
                    <a href="https://online.flippingbook.com/view/677157119/" data-aos="zoom-in" target="_blank" class="bth-catalog">ภาษาไทย</a> &nbsp;&nbsp; &nbsp;&nbsp; 
                    <a href="https://online.flippingbook.com/view/677157119/" data-aos="zoom-in" target="_blank" class="bth-catalog">English</a>
                    <br><br>
                    <p class="text-catalog" data-aos="zoom-in">
                      สามารถดูตารางเปรียบเทียบผลิตภัณฑ์ทั้งหมดของเราได้ที่ &nbsp;&nbsp;&nbsp; <a href="https://online.flippingbook.com/view/677157119/" target="_blank" class="bth-comparison">คลิกที่นี้</a>
                    </p>
              </div>
          </div>
          </div>
    ...
    <div class="brand-story">
      ...
      <br>
      <a class="list" href="BandStory.php" data-aos="zoom-in"> See More </a>
    </div>
  </div>
