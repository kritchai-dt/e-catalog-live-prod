  ...
  <div class="section">
    ...
    <div class="container" id="crudApp">
      ...
      <div  class="menu">
        <div class="row">
          <div class="col-lg-7">
            <h2>การจัดการข้อมูลหน้า Home</h2>
          </div>
        ...
        <div class="row">
          <div class="col-6">
            <input type="button" class="btn btn-success btn-xs" data-bs-toggle="modal" data-bs-target="#modalHome"
              @click="openModel" value="เพิ่มข้อมูล" />
          </div>
        </div>
        <div class="row " >
          <div class="col-6 col-md-4 col-lg-3 mt-4" v-for="row in allData">
            <div class="box-content"  data-bs-toggle="modal" data-bs-target="#modalHome" @click="fetchData(row.id)">
        ...
        <div v-if="modalHome" id="modalHome" class="modal fade" tabindex="-1">
...
let app = new Vue({
 ...
 methods:{
  ...
  submitData(){
   if(app.product_name != '' && app.img_src != '' &&  app.category != '' &&  app.display_flag != '') {
