      ...
      <div  class="menu">
        ...
        <div class="row"> 
            ...
            <div class="box-brochure" :class="{ 'box-disable': row.display_flag == 'N' }" data-bs-toggle="modal" data-bs-target="#modalBrochure" @click="fetchData(row.id)">
                ...
                <h2>{{ row.description_name }} ddddddd</h2> 
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="row mb-3">
                  <label class="col-sm-3 col-form-label font-20"> Document </label>
                  <div class="col-sm-9">
                      <input type="hidden" v-model="file_src" />
                      <input type="file" class="form-control" ref="fileTH"  />
                      <input type="button" class="btn btn-primary btn-xs mt-2" @click="uploadPDF" value="Upload Document" /> 
...
let app = new Vue({
 ...
 methods:{
  ...
  submitData(){
   if(app.description_name != '' && app.file_src != '' &&  app.display_flag != '') {
