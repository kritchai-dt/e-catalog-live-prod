...
<html>
 ...
 <body>
  ...
  <div class="section">
    ...
    <div class="container" id="crudApp">
      ...
      <div  class="menu">
        <div class="row">
          <div class="col-lg-7">
            <h2>การจัดการข้อมูลหน้า Document</h2>
          </div>
  <div class="col-4 col-lg-2 offset-lg-2 text-right">
        ...
        <div class="row">
          <div class="col-6">
            <input type="button" class="btn btn-success btn-xs" data-bs-toggle="modal" data-bs-target="#modalDocument"
        ...
        <div class="row"> 
            ...
            <div class="box-brochure" :class="{ 'box-disable': row.display_flag == 'N' }" data-bs-toggle="modal" data-bs-target="#modalDocument" @click="fetchData(row.id)">
                <button type="button" name="delete" class="btn btn-danger btn-xs delete" @click="deleteData(row.id)">X</button>    
                <div style="padding-left: 25px;"> 
                <h2>{{ row.description_name }}</h2> 
        ...
        <div v-if="modalDocument" id="modalDocument" class="modal fade" tabindex="-1">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title">{{ dynamicTitle }}</h4>
                <!-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" @click="modalDocument=false"></button> -->
              ...
              <div class="modal-body">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                      <input type="text" class="form-control" v-model="description_name"  />
                  </div>
                </div>
                <div class="row mb-3">
...
let app = new Vue({
 ...
 methods:{
  ...
  openModel(){
   app.description_name = '';
   app.file_src = '';
   app.display_flag = 'Y';
   app.actionButton = "Insert";
   app.dynamicTitle = "Add Document";
   app.modalDocument = true;
  },
  closeModal(){
    app.description_name = '';
    app.file_src = '';
    app.modalDocument = false;
  ...
  submitData(){
   if(app.description_name != '' && app.display_flag != '' && app.file_src != '') {
    if(app.actionButton == 'Insert')
    {
      axios.post('action.php', {
      action:'insertDocument',
      DescriptionName:app.description_name,
      FileTH:app.file_src,
